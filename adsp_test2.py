...
questions = [
           ...
           # 2주차 (10문제)
    {
        "week": 2,
        "question": """문제 1
    데이터 분석을 하던 중 일부 데이터가 비어있음을 발견했다. R에서 결측값을 확인하고자 한다. 
    다음 R 코드의 실행 결과로 올바른 것은 무엇인가?
    x <- c(1, 2, NA, 4, NA)
    is.na(x)""",
        "code": None,
        "options": [
    ...
    },
    {
        "week": 2,
        "question": """문제 2
    다음과 같이 결측값이 포함된 데이터프레임이 있다. 분석 전에 결측값이 있는 행을 제거하고자 한다.
    ...
    },
    {
        "week": 2,
        "question": """문제 3
    설문조사 결과 일부 응답이 결측값으로 나타났다. 분석을 위해 결측값을 해당 변수의 평균값으로 대체하려고 한다. 
    이 방법은 무엇이라 하는가?""",
        "code": None,
